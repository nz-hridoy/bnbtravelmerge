...
Route::group(['middleware' => ['locale']], function () {
	...
	Route::get('blogs', 'BlogController@index')->name('home.blogs');
	Route::get('blogs/{slug}', 'BlogController@viewPost')->name('home.blogPost');
	Route::get('contact-us', 'HomeController@contactUs')->name('home.contactUs');
	Route::post('contact-us/send', 'HomeController@sendContactusMessage')->name('home.sendContactMsg');
});
...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin', 'middleware' => ['guest:admin']], function () {
	...
	Route::group(['middleware' => 'permission:manage_blogs'], function () {
		Route::get('blogs', 'BlogController@index')->name('admin.allBlogs');
		Route::get('blogs/add-new-blog', 'BlogController@addBlog')->name('admin.addNewBlogs');
		Route::post('blogs/add-new-blog/submit', 'BlogController@storeBlogPost')->name('admin.storeBlogPost');
		Route::get('blogs/delete-post/{id}', 'BlogController@deleteBlogPost')->name('admin.deleteBlogPost');
		Route::get('blogs/edit-blog/{id}', 'BlogController@editBlog')->name('admin.editBlog');
		Route::post('blogs/update-blog', 'BlogController@updateBlog')->name('admin.updateBlog');
	});

	Route::group(['middleware' => 'permission:manage_contact_messages'], function () {
		Route::get('contact-messages', 'ContactController@index')->name('admin.contactMessages');
	});
	...
	Route::group(['middleware' => 'permission:view_reports'], function () {
		...
		Route::get('disputes', 'ReportsController@viewDisputes');
	});
	...
	Route::group(['middleware' => 'permission:general_setting'], function () {
		...
		Route::post('settings/delete_background', 'SettingsController@deleteBackground');
		...
		Route::group(['middleware' => 'permission:text_widget'], function () {
			Route::get('settings/text-widget', 'SettingTextWidgetController@index');
			Route::post('settings/text-widget', 'SettingTextWidgetController@storeData')->name('postTextWidget');
		});
...
Route::group(['middleware' => ['guest:users', 'locale']], function () {
	...
	Route::get('send-verification-code', 'HomeController@sendVerificationCode')->name('sendVerificationCode');
	Route::post('submit-verification-code', 'HomeController@submitVerificationCode')->name('submitVerificationCode');
	...
	Route::post('booking/dispute', 'BookingController@dispute');
