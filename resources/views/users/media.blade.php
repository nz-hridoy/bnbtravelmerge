                        ...
                        <div class="row mt-5 border pt-4 pb-4 rounded">
                            <div class="col-md-3">
                                @if($result->profile_image)
                                    <img width="200" height="200" title="{{ Auth::user()->first_name }}" src="{{  url('public/images/profile').'/'.Auth::user()->id.'/'.$result->profile_image }}" alt="{{ $result->first_name }}" onerror="this.onerror=null;this.src='{{ asset('public/images/placeholderuser.jpg') }}';">
                                    @else
