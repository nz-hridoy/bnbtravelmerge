										...
										<div class="list-wrap overflow-hidden-x">
											@forelse($messages as $message)
												...
												<div class="list p-2 conversassion" data-id="{{ $message->bookings->id }}">
													<img src="{{ $message->bookings->$user->profile_src }}" alt="user" onerror="this.onerror=null;this.src='{{ asset('public/images/placeholderuser.jpg') }}';" />
													<div class="info">
										...
										<header>
											...
											@endphp
												<a href="{{ url('/') }}/users/show/{{ $booking->$users->id}}">
													<img src="{{ $booking->$users->profile_src}}" alt="img" class="img-40x40" onerror="this.onerror=null;this.src='{{ asset('public/images/placeholderuser.jpg') }}';" >
												</a>
										...
										<div class="col-md-12 p-0">
											<div class="full-table mt-2 border text-dark rounded-3 pt-3 pb-3 mb-4 p-4">
												...
												<p class="row margin-top10 text-justify text-16 mb-0">
													...
													<span class="text-right col-sm-6 text-14">${{$booking->accomodation_tax}}</span>
												</p>
												@endif
