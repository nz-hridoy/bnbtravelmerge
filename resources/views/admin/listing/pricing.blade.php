   ...
   <div class="col-md-9">
    <form id="listing_pricing" method="post" action="{{url('admin/listing/'.$result->id.'/'.$step)}}" class='signup-form login-form' accept-charset='UTF-8'>
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-8">
            <select id='' name="cancellation_policy" class='form-control'>
        ...
        <div class="row">
          <div class="col-md-8">
            <small><b>Flexible:</b> Full refund 1 day prior to arrival</small><br>
            <small><b>Moderate:</b> Full refund 7 days prior to arrival</small><br>
            <small><b>Strict:</b> 50% refund for cancellations made at least 7 days before check-in. No refunds for cancellations made within 7 days of check-in.</small>
          </div>
        </div>
