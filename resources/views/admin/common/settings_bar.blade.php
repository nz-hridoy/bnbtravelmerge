<div class="box box-info box_info">
	<div class="panel-body">
		...
		<ul class="nav navbar-pills nav-tabs nav-stacked no-margin" role="tablist">
			...
			@if(Permission::has_permission(Auth::guard('admin')->user()->id, 'text_widget'))
				<li class="{{ (Route::current()->uri() == 'admin/settings/text-widget') ? 'active' : ''  }}">
					<a href="{{ url('admin/settings/text-widget') }}" data-group="profile">Text Widget</a>
				</li>
			@endif
