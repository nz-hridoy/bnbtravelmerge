<aside class="main-sidebar">
	...
	<ul class="sidebar-menu">
		...
		@if(Helpers::has_permission(Auth::guard('admin')->user()->id, 'manage_blogs'))
			<li class="{{ (Route::current()->uri() == 'admin/blogs') || (Route::current()->uri() == 'admin/blogs/add-new-blog') ? 'active' : ''  }}"><a href="{{ url('admin/blogs') }}"><i class="fa fa-th"></i><span>Blogs</span></a></li>
		@endif

		@if(Helpers::has_permission(Auth::guard('admin')->user()->id, 'manage_contact_messages'))
			<li class="{{ (Route::current()->uri() == 'admin/contact-messages') ? 'active' : ''  }}"><a href="{{ url('admin/contact-messages') }}"><i class="fa fa-envelope"></i><span>Contact Messages</span></a></li>
		@endif
		...
		@if(Helpers::has_permission(Auth::guard('admin')->user()->id, 'view_reports'))
			<li class="treeview {{ (Route::current()->uri() == 'admin/sales-report' || Route::current()->uri() == 'admin/sales-analysis' || Route::current()->uri() == 'admin/overview-stats') ? 'active' : ''  }}">
				...
				<li class="{{ (Route::current()->uri() == 'admin/disputes') ? 'active' : ''  }}"><a href="{{ url('admin/disputes') }}"><span>Dispute</span></a></li>
				</ul>
			</li>
		@endif
