<div class="form-group">
	...
	<div class="col-sm-6">
		...
		{!! isset($field['custom_span3'])?'<span name="mySpan2" class="remove_background_preview" id="mySpan2"></span>':'' !!}
		{!! isset($field['custom_company_background'])?'<input id="hidden_company_background" name="hidden_company_background" data-rel="'.$field['custom_company_background'].'" type="hidden" >':'' !!}
	</div>
