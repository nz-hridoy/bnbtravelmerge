            ...
            <div class="main-panel">
                <div class="container-fluid min-height">
                    ...
                    @forelse($bookings as $booking)
                        <?php 
                            if ($booking->created_at < $yesterday && $booking->status != 'Paid' && $booking->status != 'Disputed') {
                                        ...
                                        <p class="text-14 mt-3">
                                            ...
                                            <span class="{{ $booking->status == 'Paid' ? '' : 'd-none' }}">
                                                <a href="{{ url('/') }}/booking/receipt?code={{ $booking->code }}">
                                                    <i class="fas fa-receipt"></i> {{ trans('Payout') }}
                                                </a>
                                            ...
                                            <span class="{{ $booking->cancelled_at != '' ? 'd-none' : '' }}">
                                                <a href="javascript:void(0)" data-toggle="modal" data-target="#cancel-trip-modal" id="cancel_booking_btn" data-booking_cancel_id="{{ $booking->id }}" class="ml-2">
                                            ...
                                            <div class="row justify-content-center">
                                                <div class='img-round'>
                                                    <a href="{{ url('/') }}/users/show/{{ $booking->user_id }}">
                                                        <img src="{{ $booking->users->profile_src }}" alt="{{ $booking->users->first_name }}" class="rounded-circle img-70x70" onerror="this.onerror=null;this.src='{{ asset('public/images/placeholderuser.jpg') }}';">
                                                    </a>
                                                </div>
                                            </div>
    ...
    <div class="modal fade mt-5 modal-z-index" id="cancel-trip-modal" tabindex="-1" role="dialog" aria-labelledby="dispute-booking-modal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <div class="w-100 pt-3">
                            <h4 class="modal-title text-20 text-center font-weight-700">Cancel Booking</h4>
                        </div>
                    ...
                    <div class="modal-body p-4">
                        <form accept-charset="UTF-8" action="{{ url('booking/host_cancel') }}" id="cancel_reservation_form" method="post" name="cancel_reservation_form">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="cancel_message" class="row-space-top-2">
                                        {{ trans('Leave your message for guest') }}
                                    </label>
