    ...
    <div class="main_menu">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid container-fluid-90">
                <a class="navbar-brand logo_h" aria-label="logo" href="{{ url('/') }}"><img src="{{ $logo ?? '' }}" style="height: 50px;" alt="logo"></a>
				<!-- Trigger Button -->
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    <div class="nav navbar-nav menu_nav justify-content-end">
                        {{-- @auth
                            <div class="nav-item">
                                <a class="nav-link" href="#"><i class="far fa-bell" style="font-size: 25px;"></i></a><sub><i class="fa fa-circle" style="font-size: 12px; margin-left: -10px; border: 2px solid white; border-radius: 50%; color: red;"></i></sub>
                            </div>
                        @endauth --}}
                            ...
                            <div class="d-flex">
                                <div>
                                    <div class="nav-item mr-0">
                                        <img src="{{Auth::user()->profile_src}}" class="head_avatar" alt="{{Auth::user()->first_name}}" onerror="this.onerror=null;this.src='{{ asset('public/images/placeholderuser.jpg') }}';">
                                    </div>
                                </div>
                                <div>
