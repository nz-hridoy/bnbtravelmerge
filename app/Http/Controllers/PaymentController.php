...
class PaymentController extends Controller
{
    ...
    { 
        ...
        $booking->discount          = Session::get('discount_amount');
        ...
        $booking->status            = (Session::get('payment_booking_type') == 'instant') ? 'Paid' : 'Pending';
    ...
    public function addBookingPaymentInHostWallet($booking)
    {
      $walletBalance = Wallet::where('user_id',$booking->host_id)->first();
       $balance = ( $walletBalance->balance + $booking->total - $booking->service_charge - $booking->accomodation_tax - $booking->iva_tax );
